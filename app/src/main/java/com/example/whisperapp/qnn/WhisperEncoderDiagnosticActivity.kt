    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            Column(Modifier.fillMaxSize().padding(16.dp)) {
                ...
                Button(onClick = { runDiagnostic() }, enabled = status != "Running", modifier = Modifier.fillMaxWidth()) { Text("Run Encoder Diagnostic") }
                Spacer(Modifier.height(8.dp))
        ...
        if (intent.getBooleanExtra("run_encoder_test", false)) runDiagnostic()
    }
